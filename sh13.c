...
void handle_server_response(){
	...
	case 'V':
		...
		if(tableCartes[pId][oId] < 0 || tableCartes[pId][oId] == 100)
...
int main(int argc, char **argv)
{
	...
	gobutton = IMG_Load("assets/gobutton.png");
	connectbutton = IMG_Load("assets/connectbutton.png");
	...
	synchro = 0;
	ret = pthread_create(&thread_serveur_id, NULL, fn_serveur_tcp, NULL);
